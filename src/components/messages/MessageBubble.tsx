...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message, isOwn, language }) => {
  ...
  return (
    <div className={`flex ${isOwn ? 'justify-end' : 'justify-start'} animate-in fade-in slide-in-from-bottom-2`}>
      <div
